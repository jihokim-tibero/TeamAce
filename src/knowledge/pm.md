...
| 도구 | 용도 | 숙련도 |
|------|------|--------|
| Notion API (curl) | 기획서·기능 명세서 작성·관리 | 실전 경험 |
...
|------|---------|------|------------|---------|
| 2026-03-30 | yoseek | 서비스 기획서 + 기능 명세서 | https://www.notion.so/yoseek-33318a01a4e881f29c58e8e62b81e2a7 | Notion MCP 미연결 시 REST API 직접 활용. 테이블·코드블록·체크리스트 블록 생성 패턴 습득 |
| 2026-03-30 | yoseek | Notion 산출물 검토·보강·정리 | https://www.notion.so/33318a01a4e881f29c58e8e62b81e2a7 | notion-move-pages로 산하 페이지 이동. QA 문서와 기능 명세서 간 필드명 불일치 발견 → 기능 명세서 v1.1 보강 |
| 2026-03-30 | tag-agent | 서비스 기획서 + 기능 명세서 | https://www.notion.so/33318a01a4e88162bb65d3f1816d2eac (기획서), https://www.notion.so/33318a01a4e8814c9ac4e1b15dc6aa8b (기능 명세서) | LangGraph 9노드 그래프 구조 파악 후 Deep 모드 기능 명세화. SSE 스트림 이벤트 계약(reasoning_step/plan_user_questions/done) 기반 수락기준 작성 |
| 2026-03-30 | OwlAI | Notion 구조 재정비 + 경쟁력 있는 기획서 + 기능 명세서 | https://www.notion.so/33318a01a4e88131a6e9fe745aec6c7b (기획서), https://www.notion.so/33318a01a4e881f0b8a2e29a37cf0189 (기능 명세서) | 요구사항정의서 8개 REQ → 16개 기능 분해. 시장 분석(경쟁사 5개), KPI, 4단계 데모 시나리오 작성 |
...
### 2026-03-30 — yoseek 기획서·기능 명세서 최초 작성
...
- 문서 간 필드명 불일치 발견: 기능 명세서(storeName, aiBrief) vs QA 시나리오(businessName, advisorBrief)
- 기능 명세서 v1.1 보강: storeName→businessName, aiBrief→advisorBrief, selectedPublicDataId 추가, PUBLIC_DATA_SELECTION_REQUIRED 상태 추가
